              ...
              <ul id="registerFormDropdown" class="dropdown-menu dropdown-menu-right mt-2">
                <li class="px-3 py-2">
                  <form id="registerForm" class="form" role="form">
                    <p>Register for the blog</p>
                    <div class="form-group">
                      <input id="registerEmailInput" placeholder="Email" class="form-control form-control-sm"
                             type="text"
                             required="" pattern="\S+@\S+\.\S+" name="registerEmailInput">
                    </div>

                    <div class="form-group">
                      <div class="input-group mb-3">
                        <input id="registerPasswordInput" placeholder="Password" class="form-control form-control-sm"
                               type="password" required="" name="registerPasswordInput">
                        <div class="input-group-append">
                          <a id="showHidePassword" href=""><i id="eyeCon" class="input-group-text fa fa-eye-slash"></i></a>
                        </div>
                        <input id="registerPasswordInputConfirm" placeholder="Confirm Password"
                    ...
                    <div class="form-group">
                      <button id="registerFormSubmitButton" type="submit" class="btn btn-primary btn-block">Register
                      </button>
                    </div>
